...
### 1. (주)오픈메이트온 데이터온/트렌드온/세이프온 AWS 이관    
  진행기간: 2021.03 ~ 진행중    
  주요내용: 데이터온/트렌드온/세이프온 서비스 AWS로 이관    
  프로젝트 인원 수: 1명(본인)    
  본인 포지션(기여도): 인프라(100%)  
  본인이 기여한 점: 데이터온/트렌드온/세이프온 AWS로 인프라 설계 및 이관  
  본인이 사용한 스킬: IAM, Route53, CloudFront, ACM, S3, ALB, ECS(EC2기반), ECR, CodeCommit, CodeBuild, CodeDeploy, CodePipeline, RDS  
  결과: 데이터온(https://data-on.co.kr), 트렌드온(https://trend-on.co.kr), 세이프온(https://safe-on.co.kr)  
  
### 2. (주)오픈메이트온 홈페이지/스마트온 AWS 이관  
...
### 5. (주)오픈메이트온 홈페이지 리뉴얼  
  ...
  결과: https://openmate-on.co.kr(운영)  
  
### 6. (주)오픈메이트온 4.15 총선 페이지 개발  
  ...
  결과: https://smart-on.co.kr(운영, 모바일에서 확인)  
...
### 8. (주)오픈메이트온 신규 서비스 인프라 환경 구축  
  ...
  결과: https://git.openmate-on.co.kr(운영), 개발 & 운영 인프라 동기화  
  
### 9. (주)오픈메이트온 신규 서비스 개발  
  진행기간: 2019.10 ~ 2020.01  
  ...
  결과: https://smart-on.co.kr(운영)  
  
### 10. (주)오픈메이트온 임시 홈페이지 개발  
...
### 13. 국가정보자원관리원 로그적재 Restful API 개발  
...
### 14. (주)오픈메이트 내부서비스 Restful API 개발  
