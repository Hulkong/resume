...
| :-------------------------------------------------------------------------------: | :-----------------------------: | :-------------------: | :----------------------------------: |
| [KASA](https://www.kasa.co.kr) | 2021.09.01 ~  | 데브옵스엔지니어 | AWS 기반 인프라 구축, 운영 및 자동화 / 인프라 자원 최적화 및 보안 안정화 / DB 모니터링 및 성능 최적화 / 어플리케이션 서비스 모니터링, 로깅 및 알람 구성 지원 / 서비스 및 인프라 관련 장애 대응 |
